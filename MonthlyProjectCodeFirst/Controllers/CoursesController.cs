...
namespace MonthlyProjectCodeFirst.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Courseid,coursename,studentid,teacherid")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Courseid,coursename,studentid,teacherid")] Course course)
        {
            if (ModelState.IsValid)
            {
